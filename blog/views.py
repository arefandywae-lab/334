...
def login_full_view(request):
    if request.method == "POST":
        ...
        form = AuthenticationForm()
    return render(request, 'blog/login_full.html', {'form': form})
...
def register_full_view(request):
    if request.method == "POST":
        ...
        form = UserCreationForm()
    return render(request, 'blog/register_full.html', {'form': form})
