# 🛡️ คู่มือตะลุยสอบ Django (Windows Edition - เจาะลึกระดับ Code)

คู่มือนี้ออกแบบมาเพื่อการทำสอบบนระบบปฏิบัติการ **Windows** โดยเฉพาะ อธิบายเจาะลึกไปถึงระดับโค้ด พร้อมตัวอย่างการดัดแปลงโปรเจกต์หากโจทย์เปลี่ยนไปจากเว็บ Blog แบบเดิม
